...
func NewGinServerSet(eps EndpointSet) *GinServerSet {
	return &GinServerSet{
		CancelOrderHandler: Handler(eps.CancelOrderEndpoint, JSONBodyDecoder, JSONBodyEncoder),
		CreateOrderHandler: Handler(eps.CreateOrderEndpoint, JSONBodyDecoder, JSONBodyEncoder),
		OrderDetailHandler: Handler(eps.OrderDetailEndpoint, QueryStringDecoder, JSONBodyEncoder),
		UpdateHandler:      Handler(eps.UpdateEndpoint, JSONBodyDecoder, JSONBodyEncoder),
	}
}

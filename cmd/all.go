...
var allCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if astPkg == nil {
			cobra.CheckErr(fmt.Errorf("no valid package found in path %s, test package skipped", wd))
		}
		...
		inData, err := domain.ParseInterfaceData(pkg, astPkg, typeName)
		cobra.CheckErr(err)
		...
		err = gen.GenerateEndpoints(f, inData.Interface)
		if err != nil {
		...
		f.HeaderComment(fmt.Sprintf("Code generated by jk %s; DO NOT EDIT.", strings.Join(os.Args[1:], " ")))
		utils.InitializeFileCommon(f)
		gen.GenerateHTTPTransport(f, inData, apiVer)
		...
		err = gen.GenerateSwagger(file, inData)
		if err != nil {

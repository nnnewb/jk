...
var allCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err != nil {
			log.Fatalf("generate gin server code failed, error %+v", err)
		}

		err = f.Save("transport_gin_gen.go")
		if err != nil {
			log.Fatalf("render generated transport layer (gin) code failed, error %+v", err)
		}
	},
}
